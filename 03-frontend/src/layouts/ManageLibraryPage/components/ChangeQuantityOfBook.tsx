...
const ChangeQuantityOfBook: React.FC<{ book: BookModel,deleteBook:any }> = (props, key) => {
  ...
  return (
    <div className="card mt-3 shadow p-3 mb-3 bg-body rounded">
      <div className="row g-0">
        ...
        <button onClick={decreaseQuantity} className="m1 btn btn-md btn-warning">Deacrese Quantity</button>
      </div>
    </div>
  );
};
